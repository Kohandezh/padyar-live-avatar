# Padyar Mobile for iOS SDK Documentation

English | [中文](./README_zh.md)

## 1. Product Overview

`Padyar Mobile for iOS` is a lightweight, locally deployed 2D digital human solution for iOS, supporting real-time avatar lip-sync and motion response driven by voice.
...
| PADYAR-PRO        | Local rendering and driving manager handling model loading, render control, etc. |
...
```mermaid
graph TD
A[Check Configuration and Model] --> B[Build PADYAR Instance]
