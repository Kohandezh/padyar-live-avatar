package ai.guiji.padyar.sdk.client.thread;
...
import ai.guiji.padyar.PadyarNcnn;
import ai.guiji.padyar.sdk.client.audio.AudioPlayer;
import ai.guiji.padyar.sdk.client.bean.ImageFrame;
import ai.guiji.padyar.sdk.client.loader.ModelInfo;
import ai.guiji.padyar.sdk.client.loader.ModelInfoLoader;
import ai.guiji.padyar.sdk.client.render.RenderSink;
import ai.guiji.padyar.sdk.client.util.Logger;
...
public class RenderThread extends Thread {
    ...
    public void run() {
        ...
        scrfdncnn = new PadyarNcnn();
        String padyarDir = mContext.getExternalFilesDir("padyar").getAbsolutePath();
        ModelInfo info = ModelInfoLoader.load(mContext, scrfdncnn, padyarDir + "/model/gj_dh_res", modelDir.getAbsolutePath());
        if (info != null) {
            try {
