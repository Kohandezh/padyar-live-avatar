...
import ai.guiji.padyar.sdk.client.util.OpenGLUtil;

public final class PADYARRenderer implements PADYARTextureView.Renderer, RenderSink{

    private static final String TAG = "PADYARRenderer";

    PADYARTextureView glTextureView;
    ...
    public PADYARRenderer(Context context, PADYARTextureView glTextureView) {
        mContext = context;
