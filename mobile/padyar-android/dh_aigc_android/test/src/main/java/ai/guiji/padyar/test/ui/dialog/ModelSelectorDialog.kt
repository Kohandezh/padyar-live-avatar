package ai.guiji.padyar.test.ui.dialog

import ai.guiji.padyar.test.R
import ai.guiji.padyar.test.databinding.DialogModelSelectorBinding
import ai.guiji.padyar.test.ui.adapter.ModelSelectorAdapter
