# Padyar SDK Privacy Statement

**Last Updated:** 2025/06/09  
**SDK Name:** Padyar Real-time Interaction SDK  
**Provider:** padyar.com Platform 

## 1. Introduction  
This Privacy Statement explains how [padyar.com] ("we," "us," or "our") processes user data through our open-source SDK when integrated into third-party applications ("Customer Apps"). The SDK enables real-time digital human interaction capabilities (voice/text).  
...
- **Developers:** Open issues in our GitHub Repository：[https://github.com/padyarcom].  
- **End-Users:** Contact the Customer App’s support team.  
- **Legal Requests:** support@padyar.com

**DPO Contact:** support@padyar.com 