...
@torch.no_grad()
class Avatar:
    def __init__(self, avatar_id, video_path, bbox_shift, batch_size, preparation, args, vae, fp):
    ...
    def inference(self, audio_path, out_vid_name, fps, skip_save_images, vae, unet, pe, audio_processor, whisper):
        ...
        # audio_processor = AudioProcessor(feature_extractor_path=self.args.whisper_dir)
        weight_dtype = unet.model.dtype
        # whisper = WhisperModel.from_pretrained(self.args.whisper_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--result_dir", default='./results/realtime', help="Directory for output results")
